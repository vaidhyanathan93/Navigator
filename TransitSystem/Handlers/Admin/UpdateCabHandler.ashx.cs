...
{
    /// <summary>
    /// Summary description for UpdateCabHandler
    /// </summary>
    public class UpdateCabHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            BO.UpdateCab(cab_no, cab_model, capacity, area, driver_name, driver_mobile);

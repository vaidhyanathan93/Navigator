   ...
   $("#help").click(function(){
	  ...
	  $("#notification").click(function(){
		  ...
		  if(n%2==0){
			  ...
			  $('#notificationdialog').css("visibility","hidden");
		   $("#drop").css("visibility","hidden")
		  }else{
		   if($('#maindialog').css("visibility")=="visible"){
	   closedialog($(this));}
	   if($('#notificationdialog').css("visibility")!="visible"){
		   $('#notificationdialog').css("visibility","visible");
		   }
		    $("#drop").css("visibility","visible");
	   		  $("#drop").animate({
			   top:"69",
			   },100,function(){$("#drop").css("transform","rotate(0deg)");}).animate({
			   left: "835"
			   },100);}
	  });
